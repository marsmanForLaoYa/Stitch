...
- (void)viewDidLoad {
    ...
    [cancelbtn setTitle:@"结束编辑" forState:UIControlStateNormal];
...
- (void)configGuideViews {
    ...
    NSArray *descs = @[
        @"图片已经自动识别并拼接好啦，点击‘保存’就可以保存到相册啦",@"点击编辑按钮，编辑按钮上下两张图片可以上下拖动调整位置哦"
                       ];
...
- (void)onSave:(id)sender
{
   ...
   _image = [_image addWaterText:@""];
   _image = [_image addWaterImage:[UIImage imageNamed:@""] waterImageRect:CGRectMake(_image.size.width/2, 20, 300, 300)];
